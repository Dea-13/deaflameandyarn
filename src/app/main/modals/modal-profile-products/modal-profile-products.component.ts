...
export class ModalProfileProductsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.createProductForm = this.formBuilder.group({
      ...
      opNo: [null, Validators.required],
      cnc1: [null, Validators.required],
      cnc2: [null, Validators.required],
      subContractor1: [null, Validators.required],
      punching1: [null, Validators.required],
      punching2: [null, Validators.required],
      garda3: [null, Validators.required],
      minutesPerPiece: [null, Validators.required],
      weightPerPiece: [null, Validators.required],
      lprkr: [null, Validators.required],
      lobr: [null, Validators.required],
      npr: [null, Validators.required],
      setupSameProfile: [null, Validators.required],
      setupOtherProfile: [null, Validators.required],
    });
