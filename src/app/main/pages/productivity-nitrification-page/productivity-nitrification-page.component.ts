...
export class ProductivityNitrificationPageComponent implements OnInit {
  ...
  public urls = [
    ...
    { id: 1, name: 'Channels' },
    { id: 2, name: 'diestatus' },
    { id: 3, name: 'PrimaryResourceName' },
    { id: 4, name: 'TotalKgProduced' },
    { id: 5, name: 'KgAfterLastAnodizing' },
    { id: 6, name: 'KGtoNextAnodizing' },
  ];
  ...
  constructor(
    ...
    this.arrFilters = [
      {id: 0, ind: 0, url: 'DieId', name: this.translateSnackBar.dieId, model: '', filter: '', fullFilter: '', temp: '', selectAll: false, disableScroll: '', searchFilterConf: ''},
      {id: 1, ind: 1, url: 'Channels', name: this.translateSnackBar.channels, model: '', filter: '', fullFilter: '', temp: '', selectAll: false, disableScroll: '', searchFilterConf: ''},
      {id: 2, ind: 2, url: 'diestatus', name: this.translateSnackBar.status, model: '', filter: '', fullFilter: '', temp: '', selectAll: false, disableScroll: '', searchFilterConf: ''},
      {id: 3, ind: 3, url: 'PrimaryResourceName', name: this.translateSnackBar.currentResource, model: '', filter: '', fullFilter: '', temp: '', selectAll: false, disableScroll: '', searchFilterConf: ''},
      {id: 4, ind: 4, url: 'TotalKgProduced', name: this.translateSnackBar.totalWeight, model: '', filter: '', fullFilter: '', temp: '', selectAll: false, disableScroll: '', searchFilterConf: ''},
      {id: 5, ind: 5, url: 'KgAfterLastAnodizing', name: this.translateSnackBar.kgAfterFianlNitriding, model: '', filter: '', fullFilter: '', temp: '', selectAll: false, disableScroll: '', searchFilterConf: ''},
      {id: 6, ind: 6, url: 'KGtoNextAnodizing', name: this.translateSnackBar.kgToFianlNitriding, model: '', filter: '', fullFilter: '', temp: '', selectAll: false, disableScroll: '', searchFilterConf: ''},
    ];
  }
