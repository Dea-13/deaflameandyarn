...
export class ProductivityComponent implements OnInit {
  ...
  makeTable() {
    this.columns = [
      ...
      { name: this.translateSnackBar.totalWeight, prop: 'name' },
      { name: this.translateSnackBar.usedPieces, prop: 'name' },
      { name: this.translateSnackBar.finalNitriding, prop: 'name' },
      { name: this.translateSnackBar.kgToFianlNitriding, prop: 'name' },
      { name: this.translateSnackBar.kgAfterFianlNitriding, prop: 'name' },
    ];
  }
  ...
  getRequest(count, searchValue) {
    this.limit = count;
    // this.matrixService
    // .getproductivityMatrix(this.offset, this.limit, searchValue)
    // .subscribe((data) => {
    //   this.rows = data.list;
