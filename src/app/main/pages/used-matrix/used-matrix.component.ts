...
@Component({
  selector: 'app-used-matrix',
  templateUrl: './used-matrix.component.html',
  styleUrls: ['./used-matrix.component.scss'],
})
export class UsedMatrixComponent implements OnInit {
  // Public
  public rows = [];
  ...
  getRequest(count, searchValue) {
    this.limit = count;
    // this.matrixService
    // .getUsedMatrix(this.offset, this.limit, searchValue)
    // .subscribe((data) => {
    //   this.rows = data.list;
