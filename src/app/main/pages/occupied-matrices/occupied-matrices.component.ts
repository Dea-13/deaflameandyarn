...
@Component({
  selector: 'app-occupied-matrices',
  templateUrl: './occupied-matrices.component.html',
  styleUrls: ['./occupied-matrices.component.scss'],
})
export class OccupiedMatricesComponent implements OnInit {
  // Public
  public rows = [];
  ...
  getRequest(count, searchValue) {
    ...
    // .getOccupiedMatrixWarehouse(this.offset, this.limit, searchValue)
    // .subscribe((data) => {
    //   this.rows = data.list;
