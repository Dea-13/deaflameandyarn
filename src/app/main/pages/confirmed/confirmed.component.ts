...
export class ConfirmedComponent implements OnInit {
 ...
 makeTable(){
   this.columns = [
     ...
     { name: this.translateSnackBar.invoicePrice, prop: "name" },
     ...
     { name: this.translateSnackBar.confirmation, prop: "name" },
   ];
 }
 ...
 getRequest(count, searchValue) {
   this.limit = count;
   // this.matrixService
     // .getConfirmedMatrix(this.offset, this.limit, searchValue)
     // .subscribe((data) => {
     //   this.rows = data.list;
